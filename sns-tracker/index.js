...
const oSubscriberActivityKeys = {
    SUBSCRIBER_UNSUBSCRIBED: 'SUBSCRIBER UNSUBSCRIBED', //A message (data from source Admin/Link etc) //unsubscribecontact, find1update
    SUBSCRIBER_OPENED_EMAIL: 'SUBSCRIBER OPENED_EMAIL', //A Message and campaign id //recordsendstats
    SUBSCRIBER_EMAIL_BOUNCED: 'SUBSCRIBER EMAIL_BOUNCED', //A Message and campaign id //recordsendstats
    SUBSCRIBER_CLICKED_EMAIL_LINK: 'SUBSCRIBER CLICKED EMAIL LINK', //A Message and campaign link
            ...
            switch (oSnsData.Type) {
                ...
                case "Notification":
                    try {
                        ...
                        if (["bounce", "complaint", "open", "click"].includes(sEventType.toLowerCase())) {
                            if (!(sEventType == "Click" && oMessage.click.link.startsWith("https://manage.muxemail.com/"))) {
