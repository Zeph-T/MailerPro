...
function Dashboard() {
  ...
  return (
    <div>
      ...
      <div style={{display:'flex', margin: '4rem',flexDirection:'column'}}>
      <Typography variant='h4' className={styles.bottomText}>Total Subscribers: <div className={styles.total}>{totalSubscribers}</div> </Typography>
      <Typography variant='h4' className={styles.bottomText}>Unsubscribed Contacts: <div className={styles.unsubscribed}>{unsubscribed}</div> </Typography>
      <Typography variant='h4' className={styles.bottomText}>Inactive Contacts: <div className={styles.inactive}>{inactive}</div></Typography>
      </div>
