...
export const uri = {
  ...
  GET_ALL_ADMINS_URL: BASE_URL + "/users/getAdmins",
  ADD_ADMIN_URL: BASE_URL + "/users/addAdmin",
  REMOVE_ADMIN_URL: BASE_URL + "/users/removeAdmin",
  ...
  GET_CAMPAIGNS_STATS: BASE_URL + "/campaigns/getStats",
